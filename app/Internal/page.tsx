...
const DashboardVisual = () => (
  <div className="relative w-full max-w-lg mx-auto aspect-video bg-zinc-950 border border-zinc-800 rounded-xl overflow-hidden shadow-2xl shadow-cyan-900/20 group">
    {/* Sidebar */}
    <div className="absolute left-0 top-0 bottom-0 w-16 bg-zinc-900/50 border-r border-white/5 flex flex-col items-center py-4 gap-4">
      <div className="w-8 h-8 rounded-lg bg-cyan-500/20 border border-cyan-500/30"></div>
    ...
    <div className="absolute top-12 left-16 right-0 bottom-0 p-4 grid grid-cols-2 gap-4">
       ...
       <div className="col-span-2 grid grid-cols-3 gap-3">
          {[1,2,3].map(i => (
             <div key={i} className="bg-zinc-900/50 border border-white/5 rounded-lg p-3">
                <div className="w-4 h-4 rounded bg-cyan-500/20 mb-2"></div>
       ...
       <div className="col-span-1 bg-zinc-900/50 border border-white/5 rounded-lg p-3 flex items-end gap-1 justify-between">
          {[40, 70, 50, 90, 60, 80].map((h, i) => (
             <div key={i} style={{height: `${h}%`}} className="w-full bg-gradient-to-t from-cyan-500/40 to-cyan-400/10 rounded-t-sm"></div>
          ))}
       </div>
       {/* List Area */}
...
const tab = [
  ...
  return (
    <div className="bg-[#0A0A0A] min-h-screen text-white overflow-x-hidden">
      ...
      <section className="py-32 px-4 bg-gradient-to-b from-transparent via-cyan-900/10 to-transparent">
        <div className="mx-auto max-w-7xl">
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
              ...
              <div className="w-full md:w-80 p-8 bg-zinc-900/80 backdrop-blur-xl border border-cyan-500/30 rounded-3xl shadow-[0_0_50px_rgba(0,199,190,0.1)] relative">
