    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
      ...
      <div className="flex justify-center mb-8 md:mb-12">
        <div className="w-[90%] md:w-[40%] relative bg-slate-900/30 backdrop-blur-md rounded-full p-1.5 md:p-2 border border-slate-700/50">
          <div
            className="absolute top-1.5 bottom-1.5 md:top-2 md:bottom-2 w-[calc(50%-0.5rem)] rounded-full border border-cyan-400/50 transition-all duration-500 ease-out"
            style={{
...
Optymalizacja
             ...
             <button
              ...
              className={`w-1/2 py-3 md:py-4 text-center rounded-full font-mono text-xs md:text-sm font-medium transition-all duration-300 ${
                activeStrategy === "internal" ? "text-cyan-300" : "text-slate-400 hover:text-slate-300"
              }`}
>
              Wizerunek
            </button>
     ...
     <div className={`relative min-h-[900px] md:min-h-[670px]  bg-slate-900/40 backdrop-blur-xl rounded-3xl p-4 md:p-6 overflow-hidden`}>
       ...
       <div
        ...
        >
          <div className="h-full rounded-3xl border border-cyan-400/20 overflow-hidden shadow-2xl flex flex-col md:flex-row">
            ...
            <div className="flex-1 p-4 md:p-8">
              <div className="mb-6">
                ...
                <p className="text-xs md:text-sm text-cyan-400/80 font-mono uppercase tracking-widest">Inżynieria biznesu</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6 ">
                {[
                  ...
                  >
                    ...
                    <p className="text-2xl font-mono font-bold text-cyan-300">{metric.value}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-slate-950/50 rounded-xl border border-slate-700/30 p-4 md:p-6 mb-4">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex gap-2 items-center">
                    <div className="w-3 h-3 rounded-full bg-cyan-400/50 border border-cyan-400"></div>
                ...
                <div className="flex items-end justify-between h-32 gap-1 md:gap-2">
                  {[45, 52, 48, 65, 72, 68, 85, 82, 94, 92, 96, 100].map((height, i) => (
                    <div
                      key={i}
                      className="flex-1 bg-gradient-to-t from-cyan-400/50 to-cyan-400/30 rounded-t-sm border-t border-cyan-400/50 transition-all duration-300"
                      style={{ height: `${height}%` }}
                    />
                  ))}
                </div>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between text-xs font-mono border-b border-slate-800/50 pb-2 last:border-0 last:pb-0">
                      ...
                      <div className="flex items-center gap-2 md:gap-3">
                        <span className={item.status === "Sukces" || item.status === "Gotowe" ? "text-cyan-400" : "text-yellow-400"}>
                          {item.status}
                        </span>
