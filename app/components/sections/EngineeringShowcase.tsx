            ...
            >
              <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className={`text-2xl font-bold mb-6 text-pretty text text-transparent bg-clip-text ${selectedCase==="external" ? "bg-linear-to-r" : "bg-linear-to-l"} from-[#007AFF] to-teal-400`}>{currentCase.title}</h3>
